...
def sidebar():
    with st.sidebar:
        ...
        st.markdown(
            "JobGPT is currently using a self web scrapped dataset from Capital One, so it is updated bi-weekly(Or as fast as I could). This product is still a work in progress..."
